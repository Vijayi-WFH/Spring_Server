...
@Entity
@Table(name = "deliverables_delivered_history", schema = Constants.SCHEMA_NAME)
@Getter
@Setter
@AllArgsConstructor
@NoArgsConstructor
public class DeliverablesDeliveredHistory {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "deliverables_delivered_history_id")
    private Long deliverablesDeliveredHistoryId;
   ...
   @Convert(converter = DataEncryptionConverter.class)
    ...
    @Column(name = "list_of_deliverables_delivered_id", nullable = false)
