...
import com.tse.core.utils.IntegerListConverter;
...
@Entity
@Table(name = "entity_preference", schema= Constants.SCHEMA_NAME)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class EntityPreference {
    ...
    private Long allowedFileSize; // in Kb
    ...
    private Boolean isMonthlyLeaveUpdateOnProRata;

    @Column(name = "yearly_leave_update_pro_rata")
    private Boolean isYearlyLeaveUpdateOnProRata;
