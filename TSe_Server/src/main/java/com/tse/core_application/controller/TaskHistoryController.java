...
import com.tse.core_application.service.Impl.TaskHistoryService;
...
@CrossOrigin(value = "*")
@RestController
@RequestMapping(path = "/task-history")
public class TaskHistoryController {

    private static final Logger logger = LogManager.getLogger(TaskHistoryController.class.getName());
    ...
    @GetMapping(path = "/getAllHistoryByMappings/{taskId}")
    public ResponseEntity<Object> getAllTaskHistoryByFieldMappings(@PathVariable(name = "taskId") Long taskId,
                                                                   @RequestParam(name = "fieldMappings") String fieldMappings,
        ...
        logger.info("Entered getAllTaskHistoryByFieldMappings method.");

        try {
            List<TaskHistory_FieldMapping_Response> response = taskHistoryService.getAllTaskHistoryByFieldMapping(fieldMappings, taskId, timeZone);
            long estimatedTime = System.currentTimeMillis() - startTime;
            ThreadContext.put("systemResponseTime", String.valueOf(estimatedTime));
            logger.info(httpServletRequest.getRequestURI() + " API:  " + "Exited" + '"' + " getAllTaskHistoryByFieldMappings" + '"' + " method for username = " +
            ...
            logger.error(httpServletRequest.getRequestURI() + " API: " + "Something went wrong: Not able to execute getAllTaskHistoryByFieldMappings method for username = " +
